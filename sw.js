const CACHE='baby-roulette-pages-v12-3';
const ASSETS=['./','./index.html','./style.css?v=123','./deluxe.css?v=123','./app.js?v=123','./deluxe.js?v=123','./manifest.webmanifest','./icon.svg'];
