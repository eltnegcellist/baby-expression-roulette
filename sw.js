const CACHE='baby-roulette-pages-v12-1';
const ASSETS=['./','./index.html','./style.css?v=121','./deluxe.css?v=121','./app.js?v=121','./deluxe.js?v=121','./manifest.webmanifest','./icon.svg'];
