const CACHE='baby-roulette-pages-v12-2';
const ASSETS=['./','./index.html','./style.css?v=122','./deluxe.css?v=122','./app.js?v=122','./deluxe.js?v=122','./manifest.webmanifest','./icon.svg'];
